...
//            Creature creature = creatureCreator.CreateCreatureFromNodes(newGeneration[totalPopulation.Count + i +j].nodes[0], newGeneration[totalPopulation.Count + i + j].nodes);
//            creature.handle.transform.Translate(new Vector3(20 * i, 10, 0));
//            currentBatch.Add(creature);
//        }
